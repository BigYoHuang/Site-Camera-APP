...
import MapEstimatorApp from './apps/map-estimator/App'; // 原本的 App.tsx 是工地現場紀錄 (Map Estimator)
...
const Launcher: React.FC = () => {
  ...
  // Launcher 主介面 - Apple Liquid Glass 風格 (淡雅天空藍)
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-gradient-to-br from-sky-50 via-white to-blue-50">
